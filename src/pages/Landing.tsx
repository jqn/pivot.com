  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        boxShadow:
          "0 48px 96px rgba(0,0,0,0.55), 0 0 0 1px rgba(255,255,255,0.04)",
        maxWidth: "720px",
        margin: "0 auto",
      }}
    >
                ...
                >
                  ...
                  <span
                    style={{
                      fontFamily: "'DM Mono', monospace",
                      fontSize: "10px",
                      color: c.neg ? "var(--warn)" : "var(--signal)",
                    }}
                  >
                    {c.change}
                  </span>
                ...
                <div style={{ display: "flex", gap: "4px" }}>
                  <span
                    style={{
                      ...
                      fontFamily: "'DM Mono', monospace",
                      fontSize: "8px",
                      color: c.rsiWarn ? "var(--warn)" : "var(--neutral-600)",
                    }}
                  >
                    RSI {c.rsi}
                  </span>
...
const steps = [
  {
    ...
    desc: "Drop any tickers into your watchlist. Pivot begins monitoring immediately.",
  },
  {
    num: "02",
    title: "Set your conditions",
    desc: "Choose which technical conditions must align before a signal fires.",
  },
  {
    num: "03",
    title: "Act on the signal",
    desc: "When conditions converge, Pivot surfaces a clear buy signal — right in your dashboard.",
  },
];
  ...
  return (
    ...
    >
      ...
      <section
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 50% -10%, rgba(0,229,160,0.12) 0%, transparent 60%)",
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "60px" }}>
          ...
          >
            A focused toolkit built around the indicators that matter most to
          ...
          >
            ...
            <div
              style={{
                ...
                height: "1px",
                background:
                  "linear-gradient(90deg, var(--signal), rgba(0,229,160,0.3))",
              }}
            />
      ...
      <section
        style={{
          ...
          textAlign: "center",
          background:
            "radial-gradient(ellipse 60% 80% at 50% 100%, rgba(0,229,160,0.08) 0%, transparent 70%)",
        }}
      >
        <h2
          style={{
      ...
      >
        ...
        <div style={{ display: "flex", gap: "24px" }}>
          {(["dashboard", "watchlist", "signals", "settings"] as Page[]).map(
            (p) => (
              <button
                key={p}
